...
from handlers.telegraph import work_to_do
from pyrogram.types import Message
from handlers.database.chats_sql import Chats
from handlers.database import SESSION


@Client.on_message(filters.private & ~filters.text  & filters.command("tg"))
...
@Client.on_message(filters.group & filters.command(["tg"]))
