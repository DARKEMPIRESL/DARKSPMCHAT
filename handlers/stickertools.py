...
@Client.on_message(filters.command("stickerid") & ~filters.edited)
...
@Client.on_message(filters.command("getsticker") & ~filters.edited)
    ...
    try:
        if message.reply_to_message.sticker:
            ...
            try:
                ...
                await msg.edit_text("Something wrong hClientened.")
...
""" @Client.on_message(filters.command("webss") & ~filters.edited)
